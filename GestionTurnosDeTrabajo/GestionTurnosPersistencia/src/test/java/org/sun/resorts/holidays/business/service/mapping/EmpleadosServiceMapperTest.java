...
public class EmpleadosServiceMapperTest {
	...
	public void testMapEmpleadosEntityToEmpleados() {
		...
		empleadosEntity.setNickUsuario(mockValues.nextString(45));
		empleadosEntity.setPassword(mockValues.nextString(65));
		...
		assertEquals(empleadosEntity.getNickUsuario(), empleados.getNickUsuario());
		assertEquals(empleadosEntity.getPassword(), empleados.getPassword());
	...
	public void testMapEmpleadosToEmpleadosEntity() {
		...
		empleados.setNickUsuario(mockValues.nextString(45));
		empleados.setPassword(mockValues.nextString(65));
		...
		assertEquals(empleados.getNickUsuario(), empleadosEntity.getNickUsuario());
		assertEquals(empleados.getPassword(), empleadosEntity.getPassword());
