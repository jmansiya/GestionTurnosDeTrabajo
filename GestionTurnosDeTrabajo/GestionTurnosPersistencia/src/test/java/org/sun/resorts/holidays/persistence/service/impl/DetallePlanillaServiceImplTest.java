...
public class DetallePlanillaServiceImplTest {
	...
	public void findById() {
		...
		// When
		DetallePlanilla detallePlanillaFound = detallePlanillaService.findById(idDetalle);

		// Then
		assertEquals(detallePlanilla.getIdDetalle(),detallePlanillaFound.getIdDetalle());
	}
	...
	public void create() {
		...
		when(detallePlanillaJpaRepository.findOne(detallePlanilla.getIdDetalle())).thenReturn(null);
	...
	public void createKOExists() {
		...
		DetallePlanillaEntity detallePlanillaEntity = detallePlanillaEntityFactoryForTest.newDetallePlanillaEntity();
		when(detallePlanillaJpaRepository.findOne(detallePlanilla.getIdDetalle())).thenReturn(detallePlanillaEntity);
	...
	public void delete() {
		...
		// When
		detallePlanillaService.delete(idDetalle);

		// Then
		verify(detallePlanillaJpaRepository).delete(idDetalle);
