...
public class VolumenTrabajoEspecialServiceMapperTest {
	...
	public void testMapVolumenTrabajoEspecialEntityToVolumenTrabajoEspecial() {
		...
		volumenTrabajoEspecialEntity.setPuestoDeTrabajo(new PuestoDeTrabajoEntity());
		volumenTrabajoEspecialEntity.getPuestoDeTrabajo().setIdpuestoDeTrabajo(mockValues.nextInteger());
		...
		assertEquals(volumenTrabajoEspecialEntity.getPuestoDeTrabajo().getIdpuestoDeTrabajo(), volumenTrabajoEspecial.getIdPuestoTrabajo());
	}
	...
	public void testMapVolumenTrabajoEspecialToVolumenTrabajoEspecialEntity() {
		...
		volumenTrabajoEspecial.setIdPuestoTrabajo(mockValues.nextInteger());
		...
		assertEquals(volumenTrabajoEspecial.getIdPuestoTrabajo(), volumenTrabajoEspecialEntity.getPuestoDeTrabajo().getIdpuestoDeTrabajo());
	}
