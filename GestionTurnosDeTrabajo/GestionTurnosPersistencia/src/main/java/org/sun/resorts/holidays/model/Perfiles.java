/*
 * Java bean class for entity table perfiles 
...
/**
 * Entity bean for table "perfiles"
 * 
...
public class Perfiles implements Serializable
{
    ...
    private Integer    idperfiles   ; // Primary Key
    ...
    //----------------------------------------------------------------------
    /**
     * Set the "idperfiles" field value
     * This field is mapped on the database column "idPERFILES" ( type "INT", NotNull : true ) 
     * @param idperfiles
     */
    ...
    /**
     * Get the "idperfiles" field value
     * This field is mapped on the database column "idPERFILES" ( type "INT", NotNull : true ) 
