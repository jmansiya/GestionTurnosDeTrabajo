...
public class EmpleadosEntity implements Serializable {
    ...
    @Column(name="NICK_USUARIO", nullable=false, length=45)
    ...
    //----------------------------------------------------------------------
    @OneToMany(mappedBy="empleados", targetEntity=CentrosDeTrabajoEntity.class)
    ...
    @OneToMany(mappedBy="empleados", targetEntity=PuestoDeTrabajoEntity.class)
