...
@Entity
@Table(name="turnos_trabajo_especiales", catalog="sunholidayresortsbbdd" )
...
public class TurnosTrabajoEspecialesEntity implements Serializable {
    ...
    @ManyToOne
    @JoinColumn(name="TURNOS_DE_TRABAJO_idTURNOS_DE_TRABAJO", referencedColumnName="idTURNOS_DE_TRABAJO", insertable=false, updatable=false)
